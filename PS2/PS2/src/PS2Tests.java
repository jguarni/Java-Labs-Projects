...
public class PS2Tests extends TestCase {
    // helper method so that you will get more helpful error messages
    ...
    public void test_mean() {
        ...
        assertEquals(-3, ArrayStaticMethods.mean(new double[] { -1, -3, -5 }), 0.01); //add a test with negative numbers
    ...
    public void test_countWords() {
        ...
        assertEquals(0, ArrayStaticMethods.countWords("".toCharArray())); // add a test with no words
    ...
    public void test_replace() {
        ...
        assertArrayEquals(new int[]{5, 5, 5, 5}, ArrayStaticMethods.replace(new int[]{5, 5, 5, 5}, 6, 7)); // add a test where no replacements occur
    ...
    public void test_evenFront() {
        ...
        assertArrayEquals(new int[]{0, 2, 4, 6, 8}, ArrayStaticMethods.evenFront(new int[]{0, 2, 4, 6, 8})); //add 2 tests with: all evens
        assertArrayEquals(new int[]{1, 3, 5, 7, 9}, ArrayStaticMethods.evenFront(new int[]{1, 3, 5, 7, 9})); //add 2 tests with: all odds
    ...
    public void test_surroundedCharacter() {
        ...
        assertEquals(false, ArrayStaticMethods.surroundedCharacter("".toCharArray())); // add 2 tests: with an empty array
        assertEquals(true, ArrayStaticMethods.surroundedCharacter("abcdciloljnhyhm".toCharArray())); //, with multiple surrounded characters
